...
- ADRs live in `docs/adr/` and are referenced from `docs/arc42/09-architectural-decisions.md`.
...
- If this is an architectural decision, add/update an ADR in `docs/adr/` and reference it from `docs/arc42/09-architectural-decisions.md`.
