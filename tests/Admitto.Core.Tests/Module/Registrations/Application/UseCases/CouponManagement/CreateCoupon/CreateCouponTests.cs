using Amolenk.Admitto.Core.Module.Registrations.Application.UseCases.CouponManagement.CreateCoupon;
...
namespace Amolenk.Admitto.Core.Module.Registrations.Tests.Application.UseCases.CouponManagement.CreateCoupon;
