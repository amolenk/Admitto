using Amolenk.Admitto.Core.Module.Registrations.Application.UseCases.Registrations.CancelRegistration;
...
namespace Amolenk.Admitto.Core.Module.Registrations.Tests.Application.UseCases.Registrations.CancelRegistration;
