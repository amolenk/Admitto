...
public sealed class RegistrationsIntegrationEventPublisherTests
{
    ...
    [TestMethod]
    public async ValueTask SC001_RegistrationCancelled_EnqueuesRegistrationCancelledIntegrationEvent()
    {
        var teamId = TeamId.New();
        var eventId = TicketedEventId.New();
        var registrationId = RegistrationId.New();
    ...
    [TestMethod]
    public async ValueTask SC001_RegistrationReconfirmed_EnqueuesRegistrationReconfirmedIntegrationEvent()
    {
        var teamId = TeamId.New();
        var eventId = TicketedEventId.New();
        var registrationId = RegistrationId.New();
    ...
    [TestMethod]
    public async ValueTask SC001_TicketedEventReconfirmPolicyCleared_EnqueuesIntegrationEventWithNullPolicy()
    {
        var teamId = TeamId.New();
        var eventId = TicketedEventId.New();
    ...
    [TestMethod]
    public async ValueTask SC001_TicketedEventTimeZoneChanged_EnqueuesTimeZoneChangedIntegrationEvent()
    {
        var teamId = TeamId.New();
        var eventId = TicketedEventId.New();
    ...
    [TestMethod]
    public async ValueTask SC001_TicketsChanged_EnqueuesAttendeeTicketsChangedIntegrationEvent()
    {
        var teamId = TeamId.New();
        var eventId = TicketedEventId.New();
        var registrationId = RegistrationId.New();
