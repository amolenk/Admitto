...
internal sealed class UpdateTicketedEventFixture
{
    ...
    private UpdateTicketedEventFixture(bool cancelled = false)
    {
        _cancelled = cancelled;
    }

    /// <summary>Seeds an active team and an active ticketed event.</summary>
    public static UpdateTicketedEventFixture ActiveEvent() => new();

    /// <summary>Seeds an active team and a cancelled ticketed event.</summary>
    public static UpdateTicketedEventFixture CancelledEvent() => new(cancelled: true);
