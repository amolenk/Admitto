using Amolenk.Admitto.Core.Registrations.Application.UseCases.CouponManagement.GetPublicCouponDetails;
...
namespace Amolenk.Admitto.Core.IntegrationTests.Registrations.Application.UseCases.CouponManagement.GetPublicCouponDetails;
