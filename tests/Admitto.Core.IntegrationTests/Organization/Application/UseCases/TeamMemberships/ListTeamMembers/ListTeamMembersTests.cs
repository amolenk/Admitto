using Amolenk.Admitto.Core.Organization.Application.UseCases.TeamMemberships.ListTeamMembers;
using Amolenk.Admitto.Core.Organization.Contracts;

namespace Amolenk.Admitto.Core.IntegrationTests.Organization.Application.UseCases.TeamMemberships.ListTeamMembers;

[TestClass]
public sealed class ListTeamMembersTests(TestContext testContext) : AspireIntegrationTestBase
{
    [TestMethod]
    public async ValueTask ListTeamMembers_TeamHasMembers_ReturnsAllMembers()
    {
        // Arrange
    ...
    [TestMethod]
    public async ValueTask ListTeamMembers_TeamHasNoMembers_ReturnsEmptyList()
    {
        // Arrange
