using Amolenk.Admitto.Module.Registrations.Application.UseCases.Registrations.AdminRegisterAttendee;
...
public sealed class AdminRegisterAttendeeTests(TestContext testContext) : AspireIntegrationTestBase
{
    ...
    {
        var fixture = AdminRegisterAttendeeFixture.OpenWindowWithCapacity(max: 5, used: 5);
        await fixture.SetupAsync(Environment);

        var command = NewCommand(fixture.EventId, "speaker@example.com", fixture.TicketTypeSlug);
        var sut = NewHandler();
    ...
    {
        var fixture = AdminRegisterAttendeeFixture.WindowNotYetOpen();
        await fixture.SetupAsync(Environment);

        var command = NewCommand(fixture.EventId, "speaker@example.com", "general-admission");
        var sut = NewHandler();
    ...
    {
        var fixture = AdminRegisterAttendeeFixture.WindowClosed();
        await fixture.SetupAsync(Environment);
    ...
    {
        var fixture = AdminRegisterAttendeeFixture.WithoutRegistrationPolicy();
        await fixture.SetupAsync(Environment);
    ...
    {
        var fixture = AdminRegisterAttendeeFixture.WithEmailDomainRestriction("@acme.com");
        await fixture.SetupAsync(Environment);

        var command = NewCommand(fixture.EventId, "external@gmail.com", "general-admission");
        var sut = NewHandler();
    ...
    {
        var fixture = AdminRegisterAttendeeFixture.CapacityFull();
        await fixture.SetupAsync(Environment);

        var command = NewCommand(fixture.EventId, "speaker@example.com", "workshop");
        var sut = NewHandler();
    ...
    {
        var fixture = AdminRegisterAttendeeFixture.NoCapacitySet();
        await fixture.SetupAsync(Environment);

        var command = NewCommand(fixture.EventId, "speaker@example.com", "speaker-pass");
        var sut = NewHandler();
    ...
    {
        var fixture = AdminRegisterAttendeeFixture.EventCancelled();
        await fixture.SetupAsync(Environment);
    ...
    {
        var fixture = AdminRegisterAttendeeFixture.EventArchived();
        await fixture.SetupAsync(Environment);
    ...
    {
        var fixture = AdminRegisterAttendeeFixture.EventNotFound();
        await fixture.SetupAsync(Environment);
    ...
    {
        var fixture = AdminRegisterAttendeeFixture.EventWithoutTicketCatalog();
        await fixture.SetupAsync(Environment);
    ...
    {
        var fixture = AdminRegisterAttendeeFixture.WithExistingRegistration();
        await fixture.SetupAsync(Environment);
    ...
    {
        var fixture = AdminRegisterAttendeeFixture.OpenWindowWithCapacity();
        await fixture.SetupAsync(Environment);

        var command = NewCommand(fixture.EventId, "speaker@example.com",
    ...
    public async ValueTask SC014_AdminRegisterAttendee_UnknownTicketType_ThrowsUnknownTicketTypesError()
    {
        ...
        var command = NewCommand(fixture.EventId, "speaker@example.com", "premium-vip");
        var sut = NewHandler();
    ...
    {
        var fixture = AdminRegisterAttendeeFixture.WithCancelledTicketType();
        await fixture.SetupAsync(Environment);

        var command = NewCommand(fixture.EventId, "speaker@example.com", "workshop-a");
        var sut = NewHandler();
    ...
    {
        var fixture = AdminRegisterAttendeeFixture.WithOverlappingTimeSlots();
        await fixture.SetupAsync(Environment);

        var command = NewCommand(fixture.EventId, "speaker@example.com", "workshop-a", "workshop-b");
        var sut = NewHandler();
    ...
    {
        var fixture = AdminRegisterAttendeeFixture.WithAdditionalDetailSchema(
    ...
    {
        var fixture = AdminRegisterAttendeeFixture.ConcurrentCancelDetectedAtClaim();
        await fixture.SetupAsync(Environment);
    ...
    private static AdminRegisterAttendeeCommand NewCommand(
        ...
        => new(eventId, EmailAddress.From(email), ticketTypeSlugs, additionalDetails);
