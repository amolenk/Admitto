...
namespace Amolenk.Admitto.IntegrationTests.TestHelpers.Auth;

public class AccessTokenHandler(IOptions<AccessTokenOptions> options, string? tokenProviderBaseUrl = null) : DelegatingHandler
{
