...
- [ ] 3.3 Regenerate any affected generated API clients after the backend contract is available.
...
- [ ] 4.7 Run targeted Registrations/API tests covering self-service registration conflicts.
