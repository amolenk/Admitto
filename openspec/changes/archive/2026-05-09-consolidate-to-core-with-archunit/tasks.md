...
- [x] 12.1 Update `docs/arc42/05-building-block-view.md` to reflect the new `Admitto.Core` assembly and its internal namespace structure
- [x] 12.2 Update `docs/arc42/08-crosscutting-concepts.md` to document the ArchUnit enforcement mechanism and the Contracts namespace convention
- [x] 12.3 Update `AGENTS.md` agent workflow to document running `dotnet test tests/Admitto.Core.ArchTests` as the first test step after `dotnet build`
