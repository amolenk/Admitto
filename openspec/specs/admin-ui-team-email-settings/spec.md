...
Organizers manage the team's SMTP email settings and simple email branding from a dedicated Email page in the team settings area. This page is the only SMTP settings UI; event-scoped email settings are not shown.
