...
Admin user context resolution maps authenticated admin JWT requests to Admitto domain users and route scopes before authorization and endpoint handlers run.
