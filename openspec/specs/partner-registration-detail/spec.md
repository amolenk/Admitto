# Partner Registration Detail Specification

## Purpose

Partner event websites can retrieve a reduced registration detail payload for an attendee using the registration ID bearer link and a team-scoped API key.
