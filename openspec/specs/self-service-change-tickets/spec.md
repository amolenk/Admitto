# Self-Service Registration Update Specification

## Purpose

Attendees can update their own editable registration details and ticket selections for existing registrations through a public bearer-link endpoint.
