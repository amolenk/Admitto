...
- **WHEN** the attendee posts to `/api/events/{eventSlug}/registrations/reg-abc/cancel` with a valid API key for the event's team and without an Authorization header
