...
namespace Amolenk.Admitto.Core.Badges.Application.UseCases.BadgeInstanceManagement.DeleteBadgeInstance.AdminApi;
...
public static class DeleteBadgeInstanceHttpEndpoint
{
        ...
        CancellationToken cancellationToken)
    {
        await handler.HandleAsync(
            new DeleteBadgeInstanceCommand(eventId, badgeTypeId, badgeInstanceId),
            cancellationToken);
