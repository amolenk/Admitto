...
namespace Amolenk.Admitto.Core.Badges.Application.UseCases.BadgeTypes.DeleteBadgeType.AdminApi;
...
public static class DeleteBadgeTypeHttpEndpoint
{
    ...
    {
        await handler.HandleAsync(new DeleteBadgeTypeCommand(eventId, teamId, badgeTypeId), cancellationToken);
