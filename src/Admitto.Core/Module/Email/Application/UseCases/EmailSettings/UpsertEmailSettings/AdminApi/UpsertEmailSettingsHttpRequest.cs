using Amolenk.Admitto.Core.Module.Email.Application.UseCases.EmailSettings.CreateEmailSettings;
using Amolenk.Admitto.Core.Module.Email.Application.UseCases.EmailSettings.UpdateEmailSettings;
