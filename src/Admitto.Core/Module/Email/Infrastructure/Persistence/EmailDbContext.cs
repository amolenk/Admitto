...
using Amolenk.Admitto.Core.Module.Email.Infrastructure.Persistence.ValueConverters;
...
namespace Amolenk.Admitto.Core.Module.Email.Infrastructure.Persistence;
    ...
    : DbContext(options), IModuleDbContext, IEmailWriteStore, IOutboxDbContext, IDataProtectionKeyContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.ApplyConfigurationsFromAssembly(typeof(EmailDbContext).Assembly,
            t => t.Namespace?.StartsWith("Amolenk.Admitto.Core.Module.Email") == true);
