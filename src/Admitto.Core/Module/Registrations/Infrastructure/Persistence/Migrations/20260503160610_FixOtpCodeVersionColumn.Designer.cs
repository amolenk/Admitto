...
namespace Amolenk.Admitto.Core.Module.Registrations.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260503160610_FixOtpCodeVersionColumn")]
    partial class FixOtpCodeVersionColumn
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Amolenk.Admitto.Core.Module.Registrations.Domain.Entities.ActivityLog", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Amolenk.Admitto.Core.Module.Registrations.Domain.Entities.Coupon", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Amolenk.Admitto.Core.Module.Registrations.Domain.Entities.OtpCode", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Amolenk.Admitto.Core.Module.Registrations.Domain.Entities.Registration", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Amolenk.Admitto.Core.Module.Registrations.Domain.Entities.TicketCatalog", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("event_id");
            ...
            modelBuilder.Entity("Amolenk.Admitto.Core.Module.Registrations.Domain.Entities.TicketedEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Amolenk.Admitto.Core.Module.Registrations.Domain.Entities.Registration", b =>
                {
                    b.OwnsMany("Amolenk.Admitto.Core.Module.Registrations.Domain.ValueObjects.TicketTypeSnapshot", "Tickets", b1 =>
                        {
            ...
            modelBuilder.Entity("Amolenk.Admitto.Core.Module.Registrations.Domain.Entities.TicketCatalog", b =>
                {
                    b.OwnsMany("Amolenk.Admitto.Core.Module.Registrations.Domain.Entities.TicketType", "TicketTypes", b1 =>
                        {
            ...
            modelBuilder.Entity("Amolenk.Admitto.Core.Module.Registrations.Domain.Entities.TicketedEvent", b =>
                {
                    b.OwnsOne("Amolenk.Admitto.Core.Module.Registrations.Domain.ValueObjects.TicketedEventCancellationPolicy", "CancellationPolicy", b1 =>
                        {
                    ...
                    b.OwnsOne("Amolenk.Admitto.Core.Module.Registrations.Domain.ValueObjects.TicketedEventReconfirmPolicy", "ReconfirmPolicy", b1 =>
                        {
                            b1.Property<Guid>("TicketedEventId")
                                .HasColumnType("uuid");
                    ...
                    b.OwnsOne("Amolenk.Admitto.Core.Module.Registrations.Domain.ValueObjects.TicketedEventRegistrationPolicy", "RegistrationPolicy", b1 =>
                        {
                            b1.Property<Guid>("TicketedEventId")
                                .HasColumnType("uuid");
