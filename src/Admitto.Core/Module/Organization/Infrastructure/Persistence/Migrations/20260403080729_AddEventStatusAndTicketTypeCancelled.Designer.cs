...
namespace Amolenk.Admitto.Core.Module.Organization.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260403080729_AddEventStatusAndTicketTypeCancelled")]
    partial class AddEventStatusAndTicketTypeCancelled
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Amolenk.Admitto.Core.Module.Organization.Domain.Entities.TicketedEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "EventWindow", "Amolenk.Admitto.Core.Module.Organization.Domain.Entities.TicketedEvent.EventWindow#TimeWindow", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("Amolenk.Admitto.Core.Module.Organization.Domain.Entities.TicketedEvent", b =>
                {
                    b.OwnsMany("Amolenk.Admitto.Core.Module.Organization.Domain.ValueObjects.TicketType", "TicketTypes", b1 =>
                        {
