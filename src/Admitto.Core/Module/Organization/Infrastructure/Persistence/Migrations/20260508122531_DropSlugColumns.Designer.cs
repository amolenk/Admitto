...
namespace Amolenk.Admitto.Core.Module.Organization.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260508122531_DropSlugColumns")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Amolenk.Admitto.Core.Module.Organization.Domain.Entities.ApiKey", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Amolenk.Admitto.Core.Module.Organization.Domain.Entities.Team", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Amolenk.Admitto.Core.Module.Organization.Domain.Entities.User", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Amolenk.Admitto.Core.Module.Organization.Domain.Entities.ApiKey", b =>
                {
                    b.HasOne("Amolenk.Admitto.Core.Module.Organization.Domain.Entities.Team", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Amolenk.Admitto.Core.Module.Organization.Domain.Entities.Team", b =>
                {
                    b.OwnsMany("Amolenk.Admitto.Core.Module.Organization.Domain.Entities.TeamEventCreationRequest", "EventCreationRequests", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("Amolenk.Admitto.Core.Module.Organization.Domain.Entities.User", b =>
                {
                    b.OwnsMany("Amolenk.Admitto.Core.Module.Organization.Domain.Entities.TeamMembership", "Memberships", b1 =>
                        {
