...
namespace Amolenk.Admitto.Core.Registrations.Application.UseCases.TicketedEvents.UpdateAdditionalDetailSchema.AdminApi;
...
public static class UpdateAdditionalDetailSchemaHttpEndpoint
{
    ...
    private static async ValueTask<NoContent> UpdateAdditionalDetailSchema(
        ...
        ICommandHandler<UpdateAdditionalDetailSchemaCommand> handler,
