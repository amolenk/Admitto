...
namespace Amolenk.Admitto.Core.Registrations.Application.UseCases.Waitlists.RemoveWaitlistEntry.AdminApi;
...
public static class RemoveWaitlistEntryHttpEndpoint
{
    ...
    {
        var command = new RemoveWaitlistEntryCommand(eventId, teamId, ticketTypeId, entryId);
