...
namespace Amolenk.Admitto.Core.Registrations.Application.UseCases.Waitlists.GetWaitlistDetails.AdminApi;
...
public static class GetWaitlistDetailsHttpEndpoint
{
    ...
    {
        var query = new GetWaitlistDetailsQuery(eventId, teamId, ticketTypeId);
