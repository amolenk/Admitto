...
namespace Amolenk.Admitto.Core.Registrations.Application.UseCases.TicketedEventManagement.CancelTicketedEvent.AdminApi;
...
public static class CancelTicketedEventHttpEndpoint
{
    ...
    private static async ValueTask<NoContent> CancelTicketedEvent(
        Guid teamId,
        Guid eventId,
        CancelTicketedEventHandler handler,
