...
public partial class RemoveGenericBulkEmail : Migration
{
    ...
    protected override void Down(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                attendee_filter = table.Column<string>(type: "jsonb", nullable: false),
            ...
            constraints: table => table.PrimaryKey("PK_bulk_email_jobs", x => x.id));
