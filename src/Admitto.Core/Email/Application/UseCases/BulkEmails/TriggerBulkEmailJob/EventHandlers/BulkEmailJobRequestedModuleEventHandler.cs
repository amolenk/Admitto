using Amolenk.Admitto.Core.Email.Application.ModuleEvents;
using Amolenk.Admitto.Core.Shared.Application.Messaging;

namespace Amolenk.Admitto.Core.Email.Application.UseCases.BulkEmails.TriggerBulkEmailJob.EventHandlers;
