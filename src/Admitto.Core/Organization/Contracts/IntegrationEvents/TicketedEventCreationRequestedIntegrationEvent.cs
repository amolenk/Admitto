...
/// <c>TicketedEventCreatedIntegrationEvent</c> or <c>TicketedEventCreationRejectedIntegrationEvent</c> response
...
public sealed record TicketedEventCreationRequestedIntegrationEvent(
