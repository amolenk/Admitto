...
namespace Amolenk.Admitto.Core.Organization.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260815070032_AddDemoEventSlugToCreationRequests")]
    partial class AddDemoEventSlugToCreationRequests
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Amolenk.Admitto.Core.Organization.Domain.Entities.ApiKey", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Amolenk.Admitto.Core.Organization.Domain.Entities.Team", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Amolenk.Admitto.Core.Organization.Domain.Entities.User", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Amolenk.Admitto.Core.Shared.Infrastructure.Persistence.Inbox.ProcessedMessage", b =>
                {
                    ...
                    b.ToTable("processed_messages", "organization");
                });
            ...
            modelBuilder.Entity("Amolenk.Admitto.Core.Organization.Domain.Entities.ApiKey", b =>
                {
                    b.HasOne("Amolenk.Admitto.Core.Organization.Domain.Entities.Team", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Amolenk.Admitto.Core.Organization.Domain.Entities.Team", b =>
                {
                    b.OwnsMany("Amolenk.Admitto.Core.Organization.Domain.Entities.TeamEventCreationRequest", "EventCreationRequests", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                            ...
                            b1.Property<string>("ObservedEventStatus")
                                .HasMaxLength(32)
                                .HasColumnType("character varying(32)")
                                .HasColumnName("observed_event_status");

                            b1.Property<string>("PublicSlug")
                                .IsRequired()
                                .HasColumnType("text")
            ...
            modelBuilder.Entity("Amolenk.Admitto.Core.Organization.Domain.Entities.User", b =>
                {
                    b.OwnsMany("Amolenk.Admitto.Core.Organization.Domain.Entities.TeamMembership", "Memberships", b1 =>
                        {
