...
public class TicketTypeCapacity : Entity<TicketTypeId>
{
    [JsonConstructor]
    private TicketTypeCapacity(TicketTypeId id, string name, int maxCapacity, int usedCapacity) : base(id)
    {
        Name = name;
    ...
    public static TicketTypeCapacity Create(TicketTypeId id, string name, int maxCapacity, int usedCapacity)
    {
//        EnsureValidMaxCapacity(maxCapacity);
        ...
        return new TicketTypeCapacity(id, name, maxCapacity, usedCapacity);
    }
