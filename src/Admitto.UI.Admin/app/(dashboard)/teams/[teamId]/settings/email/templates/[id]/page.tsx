...
export default function TeamEmailTemplateEditorPage({
    ...
    const { teamId, id } = use(params);

    const templateApiUrl = `/api/teams/${teamId}/email-templates/${id}`;
    const previewApiUrl = `/api/teams/${teamId}/email-templates/preview`;
    const testSendApiUrl = `/api/teams/${teamId}/email-templates/${id}/test-send`;
    const backHref = `/teams/${teamId}/settings/email/templates`;
    const queryKey = ["team-email-template", teamId, id];
