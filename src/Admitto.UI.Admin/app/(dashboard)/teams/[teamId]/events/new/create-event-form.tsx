...
export function CreateEventForm() {
    ...
    async function pollCreationStatus(creationRequestId: string) {
            ...
            while (!cancelledRef.current) {
                ...
                try {
                    dto = await apiClient.get<EventCreationRequestDto>(
                        `/api/teams/${teamId}/event-creations/${creationRequestId}`
                    );
                } catch (err) {
    ...
    async function onSubmit(values: CreateEventValues) {
        ...
        await pollCreationStatus(accepted.creationRequestId);
    }
