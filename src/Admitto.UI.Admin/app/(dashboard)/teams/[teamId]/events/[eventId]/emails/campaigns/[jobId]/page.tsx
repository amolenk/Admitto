...
export default function BulkEmailDetailPage() {
    const { teamId, eventId, jobId } = useParams<{
        teamId: string;
        eventId: string;
        jobId: string;
    }>();
    ...
    const { data: job, isLoading, error } = useQuery({
        queryKey: ["bulk-email", teamId, eventId, jobId],
        queryFn: () =>
            apiClient.get<BulkEmailJobDetailDto>(
                `/api/teams/${teamId}/events/${eventId}/bulk-emails/${jobId}`
            ),
        throwOnError: false,
    });
    ...
    const cancelMutation = useMutation({
        mutationFn: () =>
            apiClient.post(`/api/teams/${teamId}/events/${eventId}/bulk-emails/${jobId}/cancel`),
        onSuccess: () => {
            toast.success("Cancellation requested.");
            queryClient.invalidateQueries({ queryKey: ["bulk-email", teamId, eventId, jobId] });
    ...
    const backHref = `/teams/${teamId}/events/${eventId}/emails/campaigns`;
