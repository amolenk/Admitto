...
// The bare email index redirects to the Campaigns tab. This server component has no markup, so
// it is exercised by calling it directly rather than rendering it.
