...
export async function GET(
    ...
    return callAdmittoApi(() => getEventEmailTemplate({ path: { teamId, eventId, id } }));
}
...
export async function PUT(
    ...
    return callAdmittoApi(() => updateEventEmailTemplate({ path: { teamId, eventId, id }, body }));
}
...
export async function DELETE(
    ...
    return callAdmittoApi(() => deleteEventEmailTemplate({ path: { teamId, eventId, id }, query: { version } }));
}
