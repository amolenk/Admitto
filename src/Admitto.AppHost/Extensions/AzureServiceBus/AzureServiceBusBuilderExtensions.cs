...
namespace Amolenk.Admitto.AppHost.Extensions.AzureServiceBus;

public static class AzureServiceBusBuilderExtensions
{
    /// <summary>
    /// The emulator is currently using sql-edge which is not compatible with the latest Linux kernel and
    /// (at least on ARM macOS) crashes on start when using recent Docker versions. SQL Edge is not going
    /// to be supported anymore. See https://github.com/dotnet/aspire/issues/9279
    /// </summary>
