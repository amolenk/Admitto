...
param log_analytics_outputs_name string
...
resource log_analytics 'Microsoft.OperationalInsights/workspaces@2025-02-01' existing = {
  name: log_analytics_outputs_name
}
...
output AZURE_LOG_ANALYTICS_WORKSPACE_NAME string = log_analytics.name

output AZURE_LOG_ANALYTICS_WORKSPACE_ID string = log_analytics.id
