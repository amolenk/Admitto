        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    email_type = table.Column<int>(type: "integer", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_vw_attendee_activity", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_vw_check_in", x => x.participant_id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_vw_attendee_activity_event_id_email_source_id",
                table: "vw_attendee_activity",
                columns: new[] { "event_id", "email", "source_id" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_vw_check_in_event_id_public_id",
                table: "vw_check_in",
