...
namespace Amolenk.Admitto.Cli.Api.Models
{
    ...
    public partial class AddContributorRequest : IAdditionalDataHolder, IParsable
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Amolenk.Admitto.Cli.Api.Models.AddContributorRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Amolenk.Admitto.Cli.Api.Models.AddContributorRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Amolenk.Admitto.Cli.Api.Models.AddContributorRequest();
        }
        /// <summary>
