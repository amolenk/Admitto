...
namespace Amolenk.Admitto.Cli.Api.Models
{
    ...
    public partial class EventEmailTemplateDto : IAdditionalDataHolder, IParsable
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Amolenk.Admitto.Cli.Api.Models.EventEmailTemplateDto"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Amolenk.Admitto.Cli.Api.Models.EventEmailTemplateDto CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Amolenk.Admitto.Cli.Api.Models.EventEmailTemplateDto();
        }
        /// <summary>
