...
public readonly record struct BaseUrl : IUriValueObject
{
    ...
    public static ValidationResult<BaseUrl> TryFrom(string? value)
    ...
    public static BaseUrl From(string? value) => TryFrom(value).GetValueOrThrow();
