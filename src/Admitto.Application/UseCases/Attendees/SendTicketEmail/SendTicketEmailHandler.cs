...
public class SendTicketEmailHandler : ICommandHandler<SendTicketEmailCommand>
{
    public ValueTask HandleAsync(SendTicketEmailCommand command, CancellationToken cancellationToken)
    {
        // TODO Get cancellation link and other stuff from registration
